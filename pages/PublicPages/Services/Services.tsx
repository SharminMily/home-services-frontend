    ...
    <div className="container mx-auto py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service: Service) => (
          <Card key={service.id} className="border-primary shadow-md hover:shadow-sm transition-shadow">
            <CardHeader>
              <div className="relative w-full h-48 mb-4">
                <Image
                  src={service.image || "https://i.ibb.co/HCM6Skh/professional-worker-fixing-bathroom-23-2148656904.jpg"}
                  alt={service.title}
                  fill
                  className="object-cover rounded-t-md"
                  // onError props server component এ support হয় না
                />
              </div>
              <CardTitle className="text-xl font-exo text-primary">{service.title}</CardTitle>
            </CardHeader>
            <CardContent>
